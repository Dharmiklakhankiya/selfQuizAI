...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-[#1a1a40] via-[#000428] to-[#004e92] flex items-center justify-center px-4">
      <div className="w-full max-w-md p-8 rounded-xl bg-[#0f172a]/80 shadow-[0_0_25px_#00f2fe] border border-[#00f2fe]/20 backdrop-blur-sm">
